...
const _range ranges[] = {
    ...
    { "OVP",            "V",      SCPI_UNIT_VOLT,   1.0, 9.0,      10.0},   // OVP_Low   = 11
...
_caldef caldefaults[] = {
    ...
    {   0.0,      2000,     9.5,        6900000,    voltADC.ADC_MIN,        voltADC.ADC_MAX,     ranges_e_Volt_Cal,   calCalType_e::calCalType_e_ADC,        state.cal.UmonLow,   0x400 }, // Umon_Low  = 3
    ...
    { 0.00299,    100,      0.95,         6000,      iSetDAC.DAC_MIN,        iSetDAC.DAC_MAX,     ranges_e_DAC16b,   calCalType_e::calCalType_e_DAC,        state.cal.IsetLow,   0x600 }, // Iset_Low  = 5
