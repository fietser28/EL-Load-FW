...
// File not used by this project. Only used for reference of options in platformio.ini
...
#define LV_TEXTAREA_DEF_CURSOR_BLINK_TIME 0
...
#  define LV_MEM_SIZE    (64U * 1024U)          /*[bytes]*/ // was 32U * 1024U
