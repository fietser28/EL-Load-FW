...
enum FlowStructures {
    FLOW_STRUCTURE_SET_PROPERTIES = 51,
    FLOW_STRUCTURE_CAL_POINT = 53,
    FLOW_STRUCTURE_CAL_CONFIG = 55,
    FLOW_STRUCTURE_KEYBOARD_INPUT = 57
};

enum FlowArrayOfStructures {
    FLOW_ARRAY_OF_STRUCTURE_SET_PROPERTIES = 52,
    FLOW_ARRAY_OF_STRUCTURE_CAL_POINT = 54,
    FLOW_ARRAY_OF_STRUCTURE_CAL_CONFIG = 56,
    FLOW_ARRAY_OF_STRUCTURE_KEYBOARD_INPUT = 58
};
