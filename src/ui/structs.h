...
enum FlowStructures {
    FLOW_STRUCTURE_SET_PROPERTIES = 46,
    FLOW_STRUCTURE_CAL_POINT = 48,
    FLOW_STRUCTURE_CAL_CONFIG = 50,
    FLOW_STRUCTURE_KEYBOARD_INPUT = 52
};

enum FlowArrayOfStructures {
    FLOW_ARRAY_OF_STRUCTURE_SET_PROPERTIES = 47,
    FLOW_ARRAY_OF_STRUCTURE_CAL_POINT = 49,
    FLOW_ARRAY_OF_STRUCTURE_CAL_CONFIG = 51,
    FLOW_ARRAY_OF_STRUCTURE_KEYBOARD_INPUT = 53
};
