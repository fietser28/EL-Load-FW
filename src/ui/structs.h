...
enum FlowStructures {
    FLOW_STRUCTURE_SET_PROPERTIES = 53,
    FLOW_STRUCTURE_CAL_POINT = 55,
    FLOW_STRUCTURE_CAL_CONFIG = 57,
    FLOW_STRUCTURE_KEYBOARD_INPUT = 59
};

enum FlowArrayOfStructures {
    FLOW_ARRAY_OF_STRUCTURE_SET_PROPERTIES = 54,
    FLOW_ARRAY_OF_STRUCTURE_CAL_POINT = 56,
    FLOW_ARRAY_OF_STRUCTURE_CAL_CONFIG = 58,
    FLOW_ARRAY_OF_STRUCTURE_KEYBOARD_INPUT = 60
};
