...
typedef struct _objects_t {
    ...
    lv_obj_t *obj9__stat_min_last;
    lv_obj_t *obj9__stat_min_min;
    lv_obj_t *obj9__stat_min_avg;
    lv_obj_t *obj9__stat_min_dev;
    lv_obj_t *obj9__stat_min_max;
    lv_obj_t *obj9__stat_min_count;
    lv_obj_t *obj10;
