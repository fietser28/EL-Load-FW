...
static void event_handler_cb_ranges_ranges(lv_event_t *e) {
    ...
    if (event == LV_EVENT_SCREEN_LOADED) {
        ...
        lv_group_add_obj(groups.encoder_group, objects.obj81__sure_but_yes);
        lv_group_add_obj(groups.encoder_group, objects.obj81__sure_but_no);
    }
}
...
static void event_handler_cb_nplc_nplc(lv_event_t *e) {
    ...
    if (event == LV_EVENT_SCREEN_LOADED) {
        ...
        lv_group_add_obj(groups.encoder_group, objects.obj89__sure_but_yes);
        lv_group_add_obj(groups.encoder_group, objects.obj89__sure_but_no);
    }
}
...
static void event_handler_cb_protections_obj91(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    if (event == LV_EVENT_PRESSED) {
        e->user_data = (void *)0;
...
static void event_handler_cb_protections_obj93(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    if (event == LV_EVENT_PRESSED) {
        e->user_data = (void *)0;
...
static void event_handler_cb_protections_obj95(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    if (event == LV_EVENT_PRESSED) {
        e->user_data = (void *)0;
...
static void event_handler_cb_protections_obj97(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    if (event == LV_EVENT_PRESSED) {
        e->user_data = (void *)0;
...
static void event_handler_cb_calibration_obj113(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    if (event == LV_EVENT_PRESSED) {
        e->user_data = (void *)0;
...
static void event_handler_cb_fan_fan(lv_event_t *e) {
    ...
    if (event == LV_EVENT_SCREEN_LOADED) {
        // group: encoder_group
        lv_group_remove_all_objs(groups.encoder_group);
        lv_group_add_obj(groups.encoder_group, objects.obj135);
        lv_group_add_obj(groups.encoder_group, objects.obj137);
        lv_group_add_obj(groups.encoder_group, objects.obj139__sure_but_yes);
        lv_group_add_obj(groups.encoder_group, objects.obj139__sure_but_no);
    }
}
...
static void event_handler_cb_fan_obj135(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        e->user_data = (void *)0;
...
static void event_handler_cb_fan_obj137(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        e->user_data = (void *)0;
...
static void event_handler_cb_display_display(lv_event_t *e) {
    ...
    if (event == LV_EVENT_SCREEN_LOADED) {
        // group: encoder_group
        lv_group_remove_all_objs(groups.encoder_group);
        lv_group_add_obj(groups.encoder_group, objects.obj149__sure_but_yes);
        lv_group_add_obj(groups.encoder_group, objects.obj149__sure_but_no);
    }
}
...
void create_screen_main() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            create_user_widget_keyboard(obj, getFlowState(flowState, 97), 143);
        }
    }
}
...
void tick_screen_main() {
    ...
    tick_user_widget_keyboard(getFlowState(flowState, 97), 143);
}
...
void create_screen_capacity() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_keyboard(obj, getFlowState(flowState, 47), 172);
        }
    }
}
...
void tick_screen_capacity() {
    ...
    tick_user_widget_keyboard(getFlowState(flowState, 47), 172);
}
...
void create_screen_ranges() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_question_yn(obj, getFlowState(flowState, 23), 209);
        }
    }
}
...
void tick_screen_ranges() {
    ...
    tick_user_widget_question_yn(getFlowState(flowState, 23), 209);
}
...
void create_screen_nplc() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_question_yn(obj, getFlowState(flowState, 31), 221);
        }
    }
}
...
void tick_screen_nplc() {
    ...
    tick_user_widget_question_yn(getFlowState(flowState, 31), 221);
}
...
void create_screen_protections() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_protections_obj91, LV_EVENT_ALL, flowState);
            add_style_selectbutton(obj);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_protections_obj93, LV_EVENT_ALL, flowState);
            add_style_select_button_red_green(obj);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 142, 30);
            lv_obj_add_event_cb(obj, event_handler_cb_protections_obj95, LV_EVENT_ALL, flowState);
            add_style_select_button_red_green(obj);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_protections_obj97, LV_EVENT_ALL, flowState);
            add_style_select_button_red_green(obj);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_font(obj, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_keyboard(obj, getFlowState(flowState, 46), 57);
        }
    }
}
...
void tick_screen_protections() {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_state(objects.obj93, LV_STATE_CHECKED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj93;
            if (new_val) lv_obj_add_state(objects.obj93, LV_STATE_CHECKED);
            else lv_obj_clear_state(objects.obj93, LV_STATE_CHECKED);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_state(objects.obj95, LV_STATE_CHECKED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj95;
            if (new_val) lv_obj_add_state(objects.obj95, LV_STATE_CHECKED);
            else lv_obj_clear_state(objects.obj95, LV_STATE_CHECKED);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_state(objects.obj97, LV_STATE_CHECKED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj97;
            if (new_val) lv_obj_add_state(objects.obj97, LV_STATE_CHECKED);
            else lv_obj_clear_state(objects.obj97, LV_STATE_CHECKED);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_state(objects.obj99, LV_STATE_CHECKED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj99;
            if (new_val) lv_obj_add_state(objects.obj99, LV_STATE_CHECKED);
            else lv_obj_clear_state(objects.obj99, LV_STATE_CHECKED);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_flag(objects.obj110, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj110;
            if (new_val) lv_obj_add_flag(objects.obj110, LV_OBJ_FLAG_HIDDEN);
            else lv_obj_clear_flag(objects.obj110, LV_OBJ_FLAG_HIDDEN);
            tick_value_change_obj = NULL;
        }
    }
    tick_user_widget_keyboard(getFlowState(flowState, 46), 57);
}
...
void create_screen_calibration() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_calibration_obj113, LV_EVENT_ALL, flowState);
            add_style_selectbutton(obj);
            lv_obj_set_style_align(obj, LV_ALIGN_DEFAULT, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xffff0000), LV_PART_MAIN | LV_STATE_DISABLED);
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_keyboard(obj, getFlowState(flowState, 53), 82);
        }
    }
}
...
void tick_screen_calibration() {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_state(objects.obj112, LV_STATE_DISABLED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj112;
            if (new_val) lv_obj_add_state(objects.obj112, LV_STATE_DISABLED);
            else lv_obj_clear_state(objects.obj112, LV_STATE_DISABLED);
            tick_value_change_obj = NULL;
        }
    }
    {
        if (!(lv_obj_get_state(objects.obj112) & LV_STATE_EDITED)) {
            ...
            int32_t cur_val = lv_dropdown_get_selected(objects.obj112);
            if (new_val != cur_val) {
                tick_value_change_obj = objects.obj112;
                lv_dropdown_set_selected(objects.obj112, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    ...
    tick_user_widget_keyboard(getFlowState(flowState, 53), 82);
    {
        float timeline_position = getTimelinePosition(flowState);
        
        static struct {
            float last_timeline_position;
            int32_t obj_obj127_rotate_init_value;
        } anim_state = { -1 };
        
        if (anim_state.last_timeline_position == -1) {
            anim_state.last_timeline_position = 0;
            anim_state.obj_obj127_rotate_init_value = lv_obj_get_style_prop(objects.obj127, LV_PART_MAIN, LV_STYLE_TRANSFORM_ROTATION).num;
        }
        ...
        if (timeline_position != anim_state.last_timeline_position) {
            ...
            {
                lv_obj_t *obj = objects.obj127;
                
                float rotate_value = anim_state.obj_obj127_rotate_init_value;
...
void create_screen_fan() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_fan_obj135, LV_EVENT_ALL, flowState);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            add_style_slider(obj);
        }
        {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_fan_obj137, LV_EVENT_ALL, flowState);
            add_style_selector_small(obj);
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_question_yn(obj, getFlowState(flowState, 31), 98);
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
...
void tick_screen_fan() {
    ...
    }
    {
        ...
        int32_t cur_val = lv_slider_get_value(objects.obj135);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj135;
            lv_slider_set_value(objects.obj135, new_val, LV_ANIM_OFF);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    {
        if (!(lv_obj_get_state(objects.obj137) & LV_STATE_EDITED)) {
            int32_t new_val = evalIntegerProperty(flowState, 29, 3, "Failed to evaluate Selected in Dropdown widget");
            int32_t cur_val = lv_dropdown_get_selected(objects.obj137);
            if (new_val != cur_val) {
                tick_value_change_obj = objects.obj137;
                lv_dropdown_set_selected(objects.obj137, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    ...
    tick_user_widget_question_yn(getFlowState(flowState, 31), 98);
    {
        const char *new_val = evalTextProperty(flowState, 33, 3, "Failed to evaluate Text in Label widget");
...
void create_screen_display() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_question_yn(obj, getFlowState(flowState, 33), 114);
        }
        {
            // display OFF
            lv_obj_t *obj = lv_obj_create(parent_obj);
...
void tick_screen_display() {
    ...
    }
    {
        ...
        int32_t cur_val = lv_slider_get_value(objects.obj144);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj144;
            lv_slider_set_value(objects.obj144, new_val, LV_ANIM_OFF);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    {
        if (!(lv_obj_get_state(objects.obj146) & LV_STATE_EDITED)) {
            int32_t new_val = evalIntegerProperty(flowState, 29, 3, "Failed to evaluate Selected in Dropdown widget");
            int32_t cur_val = lv_dropdown_get_selected(objects.obj146);
            if (new_val != cur_val) {
                tick_value_change_obj = objects.obj146;
                lv_dropdown_set_selected(objects.obj146, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    ...
    tick_user_widget_question_yn(getFlowState(flowState, 33), 114);
    {
