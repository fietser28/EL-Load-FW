...
static void event_handler_cb_events_obj48(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_fan_fan(lv_event_t *e) {
    ...
    if (event == LV_EVENT_SCREEN_LOAD_START) {
        // group: encoder_group
        lv_group_remove_all_objs(groups.encoder_group);
        lv_group_add_obj(groups.encoder_group, objects.obj70);
        lv_group_add_obj(groups.encoder_group, objects.obj71);
...
static void event_handler_cb_fan_obj70(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_fan_obj71(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_display_obj72(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_display_obj73(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_display_obj74(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
void create_screen_main() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            create_user_widget_keyboard(obj, getFlowState(flowState, 111), 15);
        }
    }
}
...
void tick_screen_main() {
    ...
    tick_user_widget_keyboard(getFlowState(flowState, 111), 15);
}
...
void create_screen_events() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_events_obj48, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_WITH_ARROW);
...
void tick_screen_calibration() {
    ...
    }
    {
        if (!(lv_obj_get_state(objects.obj58) & LV_STATE_EDITED)) {
            ...
            int32_t cur_val = lv_dropdown_get_selected(objects.obj58);
            if (new_val != cur_val) {
                tick_value_change_obj = objects.obj58;
                lv_dropdown_set_selected(objects.obj58, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    ...
    tick_user_widget_keyboard(getFlowState(flowState, 53), 50);
    {
        ...
        static struct {
            ...
            int32_t obj_obj68_rotate_init_value;
        } anim_state = { -1 };
        
        if (anim_state.last_timeline_position == -1) {
            anim_state.last_timeline_position = 0;
            anim_state.obj_obj68_rotate_init_value = lv_obj_get_style_prop(objects.obj68, LV_PART_MAIN, LV_STYLE_TRANSFORM_ROTATION).num;
        }
        ...
        if (timeline_position != anim_state.last_timeline_position) {
            ...
            {
                lv_obj_t *obj = objects.obj68;
                
                float rotate_value = anim_state.obj_obj68_rotate_init_value;
...
void create_screen_fan() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_fan_obj70, LV_EVENT_ALL, flowState);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            add_style_slider(obj);
        }
        {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_fan_obj71, LV_EVENT_ALL, flowState);
            add_style_selector_small(obj);
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
...
void tick_screen_fan() {
    ...
    }
    {
        ...
        int32_t cur_val = lv_slider_get_value(objects.obj70);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj70;
            lv_slider_set_value(objects.obj70, new_val, LV_ANIM_OFF);
            tick_value_change_obj = NULL;
        }
    }
    {
        bool new_val = evalBooleanProperty(flowState, 27, 3, "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.obj163, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj163;
            if (new_val) lv_obj_add_flag(objects.obj163, LV_OBJ_FLAG_HIDDEN);
            else lv_obj_clear_flag(objects.obj163, LV_OBJ_FLAG_HIDDEN);
            tick_value_change_obj = NULL;
        }
    }
    {
...
void create_screen_display() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 180, 10);
            lv_obj_add_event_cb(obj, event_handler_cb_display_obj72, LV_EVENT_ALL, flowState);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            add_style_slider(obj);
        }
        {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 102, 36);
            lv_dropdown_set_options(obj, "Auto\nManual");
            lv_obj_add_event_cb(obj, event_handler_cb_display_obj73, LV_EVENT_ALL, flowState);
            add_style_selector_small(obj);
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_display_obj74, LV_EVENT_ALL, flowState);
            add_style_selectbutton(obj);
            {
                lv_obj_t *parent_obj = obj;
                {
...
void tick_screen_display() {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_flag(objects.obj169, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj169;
            if (new_val) lv_obj_add_flag(objects.obj169, LV_OBJ_FLAG_HIDDEN);
            else lv_obj_clear_flag(objects.obj169, LV_OBJ_FLAG_HIDDEN);
            tick_value_change_obj = NULL;
        }
    }
    {
        if (!(lv_obj_get_state(objects.obj73) & LV_STATE_EDITED)) {
            int32_t new_val = evalIntegerProperty(flowState, 29, 3, "Failed to evaluate Selected in Dropdown widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 30, 3, "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.obj165, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj165;
            if (new_val) lv_obj_add_flag(objects.obj165, LV_OBJ_FLAG_HIDDEN);
            else lv_obj_clear_flag(objects.obj165, LV_OBJ_FLAG_HIDDEN);
            tick_value_change_obj = NULL;
        }
    }
    {
...
static const char *screen_names[] = { "Startup", "Main", "Capacity", "Settings", "events", "Ranges", "NPLC", "protections", "calibration", "Fan", "Display", "Info", "Sound", "Stats", "questionYN", "keyboard", "StatsTable" };
static const char *object_names[] = { "startup", "main", "capacity", "settings", "events", "ranges", "nplc", "protections", "calibration", "fan", "display", "info", "sound", "stats", "obj0", "obj0__kbtext2", "obj0__obj0", "obj0__max_button", "obj0__min_button", "obj0__obj1", "obj0__obj2", "obj1", "obj1__kbtext2", "obj1__obj0", "obj1__max_button", "obj1__min_button", "obj1__obj1", "obj1__obj2", "obj2", "obj2__sure_but_yes", "obj2__sure_but_no", "obj2__sure_label_yes", "obj2__sure_label_no", "obj2__obj0", "obj2__obj1", "obj3", "obj3__sure_but_yes", "obj3__sure_but_no", "obj3__sure_label_yes", "obj3__sure_label_no", "obj3__obj0", "obj3__obj1", "obj4", "obj4__kbtext2", "obj4__obj0", "obj4__max_button", "obj4__min_button", "obj4__obj1", "obj4__obj2", "obj5", "obj5__kbtext2", "obj5__obj0", "obj5__max_button", "obj5__min_button", "obj5__obj1", "obj5__obj2", "obj6", "obj6__sure_but_yes", "obj6__sure_but_no", "obj6__sure_label_yes", "obj6__sure_label_no", "obj6__obj0", "obj6__obj1", "obj7