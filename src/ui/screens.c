...
static void event_handler_cb_main_set_value_area(lv_event_t *e) {
    ...
    if (event == LV_EVENT_KEY) {
        flowPropagateValueUint32(flowState, 74, 2, lv_event_get_key(e));
    }
    if (event == LV_EVENT_SHORT_CLICKED) {
        flowPropagateValue(flowState, 74, 3);
    }
    if (event == LV_EVENT_VALUE_CHANGED) {
        flowPropagateValue(flowState, 74, 4);
    }
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
static void event_handler_cb_main_obj14(lv_event_t *e) {
    ...
    void *flowState = e->user_data;
    if (event == LV_EVENT_VALUE_CHANGED) {
        flowPropagateValue(flowState, 78, 0);
    }
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
            ...
            if (tick_value_change_obj != ta) {
                assignIntegerProperty(flowState, 78, 7, value, "Failed to assign Value in Spinbox widget");
            }
        }
    }
}
...
static void event_handler_cb_main_obj17(lv_event_t *e) {
    ...
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
        flowPropagateValue(flowState, 83, 0);
    }
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
            bool value = lv_obj_has_state(ta, LV_STATE_CHECKED);
            assignBooleanProperty(flowState, 83, 3, value, "Failed to assign Checked state");
        }
    }
}
...
static void event_handler_cb_main_obj19(lv_event_t *e) {
    ...
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
        flowPropagateValue(flowState, 85, 0);
    }
}
...
static void event_handler_cb_main_obj21(lv_event_t *e) {
    ...
    if (event == LV_EVENT_VALUE_CHANGED) {
        ...
        if (tick_value_change_obj != ta) {
            bool value = lv_obj_has_state(ta, LV_STATE_CHECKED);
            assignBooleanProperty(flowState, 88, 3, value, "Failed to assign Checked state");
        }
    }
}
...
static void event_handler_cb_main_obj24(lv_event_t *e) {
    ...
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
        flowPropagateValue(flowState, 92, 0);
    }
}
...
static void event_handler_cb_main_obj29(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
        flowPropagateValue(flowState, 99, 0);
    }
}
...
static void event_handler_cb_capacity_obj53(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
...
static void event_handler_cb_settings_obj72(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
...
static void event_handler_cb_events_obj77(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
...
static void event_handler_cb_nplc_obj93(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_VALUE_CHANGED) {
        flowPropagateValue(flowState, 25, 0);
...
static void event_handler_cb_protections_obj108(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
...
static void event_handler_cb_protections_obj113(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
...
static void event_handler_cb_fan_obj144(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_VALUE_CHANGED) {
        flowPropagateValue(flowState, 29, 0);
...
static void event_handler_cb_display_obj154(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_RELEASED) {
...
static void event_handler_cb_keyboard_obj33(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
...
void create_screen_main() {
    ...
    apply_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_pad_right(obj, 6, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_obj_set_pos(obj, 0, 0);
                    lv_obj_set_size(obj, 136, 32);
                    lv_obj_add_event_cb(obj, event_handler_cb_main_obj29, LV_EVENT_ALL, flowState);
                    apply_style_selectbutton(obj);
        ...
        }
        {
            ...
            create_user_widget_keyboard(obj, getFlowState(flowState, 101), 137);
        }
    }
}
...
void tick_screen_main() {
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 78, 3, "Failed to evaluate Digit count in Spinbox widget");
        ...
        if (new_val != cur_val) {
            ...
            if (count >= pos) {
                lv_spinbox_set_digit_format(objects.obj14, count, pos);
            }
            tick_value_change_obj = NULL;
        }
    }
    {
        int32_t new_val = evalIntegerProperty(flowState, 78, 4, "Failed to evaluate Separator position in Spinbox widget");
        lv_spinbox_t* spinbox = (lv_spinbox_t *) objects.obj14;
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 78, 5, "Failed to evaluate Min in Spinbox widget");
        lv_spinbox_t* spinbox = (lv_spinbox_t *) objects.obj14;
        ...
        if (new_val != cur_val) {
            ...
            int32_t min = new_val;
            if (min < max) {
                lv_spinbox_set_range(objects.obj14, min, max);
            }
            tick_value_change_obj = NULL;
        }
    }
    {
        int32_t new_val = evalIntegerProperty(flowState, 78, 6, "Failed to evaluate Max in Spinbox widget");
        lv_spinbox_t* spinbox = (lv_spinbox_t *) objects.obj14;
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 78, 7, "Failed to evaluate Value in Spinbox widget");
        int32_t cur_val = lv_spinbox_get_value(objects.obj14);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj14;
            lv_spinbox_set_value(objects.obj14, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 83, 3, "Failed to evaluate Checked state");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 84, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 88, 3, "Failed to evaluate Checked state");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 95, 3, "Failed to evaluate Disabled state");
    ...
    tick_user_widget_keyboard(getFlowState(flowState, 101), 137);
}
...
void create_screen_capacity() {
    ...
    apply_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_keyboard(obj, getFlowState(flowState, 46), 165);
        }
        {
            lv_obj_t *obj = lv_obj_create(parent_obj);
...
void tick_screen_capacity() {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_state(objects.obj43, LV_STATE_DISABLED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj43;
            if (new_val) lv_obj_add_state(objects.obj43, LV_STATE_DISABLED);
            else lv_obj_clear_state(objects.obj43, LV_STATE_DISABLED);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    tick_user_widget_keyboard(getFlowState(flowState, 46), 165);
}
...
void create_screen_settings() {
    ...
    apply_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 188, 32);
            lv_obj_add_event_cb(obj, event_handler_cb_settings_obj72, LV_EVENT_ALL, flowState);
            apply_style_selectbutton(obj);
            {
                lv_obj_t *parent_obj = obj;
                {
...
void tick_screen_events() {
    ...
    }
    {
        ...
        const char *cur_val = lv_textarea_get_text(objects.obj77);
        if (strcmp(new_val, cur_val) != 0) {
            tick_value_change_obj = objects.obj77;
            lv_textarea_set_text(objects.obj77, new_val);
            tick_value_change_obj = NULL;
        }
    }
}
...
void create_screen_ranges() {
    ...
    apply_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_question_yn(obj, getFlowState(flowState, 23), 203);
        }
    }
}
...
void tick_screen_ranges() {
    ...
    tick_user_widget_question_yn(getFlowState(flowState, 23), 203);
}
...
void create_screen_nplc() {
    ...
    apply_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_question_yn(obj, getFlowState(flowState, 31), 216);
        }
    }
}
...
void tick_screen_nplc() {
    ...
    }
    {
        ...
        int32_t cur_val = lv_slider_get_value(objects.obj93);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj93;
            lv_slider_set_value(objects.obj93, new_val, LV_ANIM_OFF);
            tick_value_change_obj = NULL;
        }
    }
    {
        if (!(lv_obj_get_state(objects.obj94) & LV_STATE_EDITED)) {
            int32_t new_val = evalIntegerProperty(flowState, 29, 3, "Failed to evaluate Selected in Dropdown widget");
            int32_t cur_val = lv_dropdown_get_selected(objects.obj94);
            if (new_val != cur_val) {
                tick_value_change_obj = objects.obj94;
                lv_dropdown_set_selected(objects.obj94, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    ...
    tick_user_widget_question_yn(getFlowState(flowState, 31), 216);
}
...
void create_screen_protections() {
    ...
    apply_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_protections_obj108, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_CHAIN);
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 142, 30);
            lv_obj_add_event_cb(obj, event_handler_cb_protections_obj113, LV_EVENT_ALL, flowState);
            apply_style_select_button_red_green(obj);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_font(obj, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_keyboard(obj, getFlowState(flowState, 46), 61);
        }
    }
}
...
void tick_screen_protections() {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_state(objects.obj106, LV_STATE_CHECKED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj106;
            if (new_val) lv_obj_add_state(objects.obj106, LV_STATE_CHECKED);
            else lv_obj_clear_state(objects.obj106, LV_STATE_CHECKED);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_state(objects.obj108, LV_STATE_DISABLED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj108;
            if (new_val) lv_obj_add_state(objects.obj108, LV_STATE_DISABLED);
            else lv_obj_clear_state(objects.obj108, LV_STATE_DISABLED);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_state(objects.obj113, LV_STATE_CHECKED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj113;
            if (new_val) lv_obj_add_state(objects.obj113, LV_STATE_CHECKED);
            else lv_obj_clear_state(objects.obj113, LV_STATE_CHECKED);
            tick_value_change_obj = NULL;
        }
    }
    {
        bool new_val = evalBooleanProperty(flowState, 42, 4, "Failed to evaluate Disabled state");
        bool cur_val = lv_obj_has_state(objects.obj113, LV_STATE_DISABLED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj113;
            if (new_val) lv_obj_add_state(objects.obj113, LV_STATE_DISABLED);
            else lv_obj_clear_state(objects.obj113, LV_STATE_DISABLED);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    tick_user_widget_keyboard(getFlowState(flowState, 46), 61);
}
...
void create_screen_calibration() {
    ...
    apply_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_keyboard(obj, getFlowState(flowState, 53), 87);
        }
    }
}
...
void tick_screen_calibration() {
    ...
    {
        if (!(lv_obj_get_state(objects.obj119) & LV_STATE_EDITED)) {
            int32_t new_val = evalIntegerProperty(flowState, 32, 4, "Failed to evaluate Selected in Dropdown widget");
            int32_t cur_val = lv_dropdown_get_selected(objects.obj119);
            if (new_val != cur_val) {
                tick_value_change_obj = objects.obj119;
                lv_dropdown_set_selected(objects.obj119, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 49, 3, "Failed to evaluate Disabled state");
        bool cur_val = lv_obj_has_state(objects.obj132, LV_STATE_DISABLED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj132;
            if (new_val) lv_obj_add_state(objects.obj132, LV_STATE_DISABLED);
            else lv_obj_clear_state(objects.obj132, LV_STATE_DISABLED);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    tick_user_widget_keyboard(getFlowState(flowState, 53), 87);
    {
        float timeline_position = getTimelinePosition(flowState);
        
        static struct {
            float last_timeline_position;
            int32_t obj_obj134_rotate_init_value;
        } anim_state = { -1 };
        ...
        if (timeline_position != anim_state.last_timeline_position) {
            ...
            {
                lv_obj_t *obj = objects.obj134;
                
                float rotate_value = anim_state.obj_obj134_rotate_init_value;
...
void create_screen_fan() {
    ...
    apply_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_fan_obj144, LV_EVENT_ALL, flowState);
            apply_style_selector_small(obj);
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_question_yn(obj, getFlowState(flowState, 31), 103);
        }
    }
}
...
void tick_screen_fan() {
    ...
    {
        if (!(lv_obj_get_state(objects.obj144) & LV_STATE_EDITED)) {
            int32_t new_val = evalIntegerProperty(flowState, 29, 3, "Failed to evaluate Selected in Dropdown widget");
    ...
    tick_user_widget_question_yn(getFlowState(flowState, 31), 103);
}
...
void create_screen_display() {
    ...
    apply_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_display_obj154, LV_EVENT_ALL, flowState);
            apply_style_selectbutton(obj);
            {
                lv_obj_t *parent_obj = obj;
                {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_question_yn(obj, getFlowState(flowState, 33), 116);
        }
        {
            // display OFF
            lv_obj_t *obj = lv_obj_create(parent_obj);
...
void tick_screen_display() {
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 27, 3, "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.obj150, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj150;
            if (new_val) lv_obj_add_flag(objects.obj150, LV_OBJ_FLAG_HIDDEN);
            else lv_obj_clear_flag(objects.obj150, LV_OBJ_FLAG_HIDDEN);
            tick_value_change_obj = NULL;
        }
    }
    {
        int32_t new_val = evalIntegerProperty(flowState, 27, 4, "Failed to evaluate Value in Slider widget");
        int32_t cur_val = lv_slider_get_value(objects.obj150);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj150;
            lv_slider_set_value(objects.obj150, new_val, LV_ANIM_OFF);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    {
        if (!(lv_obj_get_state(objects.obj152) & LV_STATE_EDITED)) {
            int32_t new_val = evalIntegerProperty(flowState, 29, 3, "Failed to evaluate Selected in Dropdown widget");
            int32_t cur_val = lv_dropdown_get_selected(objects.obj152);
            if (new_val != cur_val) {
                tick_value_change_obj = objects.obj152;
                lv_dropdown_set_selected(objects.obj152, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_flag(objects.obj155, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj155;
            if (new_val) lv_obj_add_flag(objects.obj155, LV_OBJ_FLAG_HIDDEN);
            else lv_obj_clear_flag(objects.obj155, LV_OBJ_FLAG_HIDDEN);
            tick_value_change_obj = NULL;
        }
    }
    tick_user_widget_question_yn(getFlowState(flowState, 33), 116);
    {
...
void create_user_widget_keyboard(lv_obj_t *parent_obj, void *flowState, int startWidgetIndex) {
    lv_obj_t *obj = parent_obj;
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_keyboard_obj33, LV_EVENT_ALL, flowState);
            lv_obj_set_style_align(obj, LV_ALIGN_TOP_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_font(obj, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
        }
        {
