...
static void event_handler_cb_main_obj14(lv_event_t *e) {
    ...
    if (event == LV_EVENT_PRESSED) {
        e->user_data = (void *)0;
        flowPropagateValueLVGLEvent(flowState, 66, 0, e);
    }
}
...
static void event_handler_cb_events_obj44(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_events_obj45(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_fan_fan(lv_event_t *e) {
    ...
    if (event == LV_EVENT_SCREEN_LOAD_START) {
        // group: encoder_group
        lv_group_remove_all_objs(groups.encoder_group);
        lv_group_add_obj(groups.encoder_group, objects.obj67);
        lv_group_add_obj(groups.encoder_group, objects.obj68);
...
static void event_handler_cb_fan_obj67(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_fan_obj68(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_display_obj69(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_display_obj70(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_display_obj71(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_sound_obj73(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_sound_obj74(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_sound_obj75(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_sound_obj76(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
static void event_handler_cb_sound_obj77(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
void create_screen_main() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            create_user_widget_keyboard(obj, getFlowState(flowState, 111), 14);
        }
    }
}
...
void tick_screen_main() {
    ...
    tick_user_widget_keyboard(getFlowState(flowState, 111), 14);
}
...
void tick_screen_capacity() {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_state(objects.obj27, LV_STATE_DISABLED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj27;
            if (new_val) lv_obj_add_state(objects.obj27, LV_STATE_DISABLED);
            else lv_obj_clear_state(objects.obj27, LV_STATE_DISABLED);
            tick_value_change_obj = NULL;
        }
    }
    {
...
void create_screen_events() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 90, 38);
            lv_obj_add_event_cb(obj, event_handler_cb_events_obj44, LV_EVENT_ALL, flowState);
            add_style_selectbutton(obj);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_events_obj45, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_WITH_ARROW);
...
void tick_screen_events() {
    ...
    }
    {
        ...
        const char *cur_val = lv_textarea_get_text(objects.obj45);
        if (strcmp(new_val, cur_val) != 0) {
            tick_value_change_obj = objects.obj45;
            lv_textarea_set_text(objects.obj45, new_val);
            tick_value_change_obj = NULL;
        }
    }
}
...
void tick_screen_protections() {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_state(objects.obj50, LV_STATE_CHECKED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj50;
            if (new_val) lv_obj_add_state(objects.obj50, LV_STATE_CHECKED);
            else lv_obj_clear_state(objects.obj50, LV_STATE_CHECKED);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_state(objects.obj51, LV_STATE_DISABLED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj51;
            if (new_val) lv_obj_add_state(objects.obj51, LV_STATE_DISABLED);
            else lv_obj_clear_state(objects.obj51, LV_STATE_DISABLED);
            tick_value_change_obj = NULL;
        }
    }
    {
...
void tick_screen_calibration() {
    ...
    {
        if (!(lv_obj_get_state(objects.obj55) & LV_STATE_EDITED)) {
            int32_t new_val = evalIntegerProperty(flowState, 32, 4, "Failed to evaluate Selected in Dropdown widget");
            int32_t cur_val = lv_dropdown_get_selected(objects.obj55);
            if (new_val != cur_val) {
                tick_value_change_obj = objects.obj55;
                lv_dropdown_set_selected(objects.obj55, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    ...
    tick_user_widget_keyboard(getFlowState(flowState, 53), 49);
    {
        ...
        static struct {
            ...
            int32_t obj_obj65_rotate_init_value;
        } anim_state = { -1 };
        
        if (anim_state.last_timeline_position == -1) {
            anim_state.last_timeline_position = 0;
            anim_state.obj_obj65_rotate_init_value = lv_obj_get_style_prop(objects.obj65, LV_PART_MAIN, LV_STYLE_TRANSFORM_ROTATION).num;
        }
        ...
        if (timeline_position != anim_state.last_timeline_position) {
            ...
            {
                lv_obj_t *obj = objects.obj65;
                
                float rotate_value = anim_state.obj_obj65_rotate_init_value;
...
void create_screen_fan() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_fan_obj67, LV_EVENT_ALL, flowState);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            add_style_slider(obj);
        }
        {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_fan_obj68, LV_EVENT_ALL, flowState);
            add_style_selector_small(obj);
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
...
void tick_screen_fan() {
    ...
    }
    {
        ...
        int32_t cur_val = lv_slider_get_value(objects.obj67);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj67;
            lv_slider_set_value(objects.obj67, new_val, LV_ANIM_OFF);
            tick_value_change_obj = NULL;
        }
    }
    {
...
void create_screen_display() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 180, 10);
            lv_obj_add_event_cb(obj, event_handler_cb_display_obj69, LV_EVENT_ALL, flowState);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            add_style_slider(obj);
        }
        {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 102, 36);
            lv_dropdown_set_options(obj, "Auto\nManual");
            lv_obj_add_event_cb(obj, event_handler_cb_display_obj70, LV_EVENT_ALL, flowState);
            add_style_selector_small(obj);
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_display_obj71, LV_EVENT_ALL, flowState);
            add_style_selectbutton(obj);
            {
                lv_obj_t *parent_obj = obj;
                {
...
void tick_screen_display() {
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 27, 3, "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.obj69, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj69;
            if (new_val) lv_obj_add_flag(objects.obj69, LV_OBJ_FLAG_HIDDEN);
            else lv_obj_clear_flag(objects.obj69, LV_OBJ_FLAG_HIDDEN);
            tick_value_change_obj = NULL;
        }
    }
    {
        int32_t new_val = evalIntegerProperty(flowState, 27, 4, "Failed to evaluate Value in Slider widget");
        int32_t cur_val = lv_slider_get_value(objects.obj69);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj69;
            lv_slider_set_value(objects.obj69, new_val, LV_ANIM_OFF);
            tick_value_change_obj = NULL;
        }
    }
    {
        bool new_val = evalBooleanProperty(flowState, 28, 3, "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.obj164, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj164;
            if (new_val) lv_obj_add_flag(objects.obj164, LV_OBJ_FLAG_HIDDEN);
            else lv_obj_clear_flag(objects.obj164, LV_OBJ_FLAG_HIDDEN);
            tick_value_change_obj = NULL;
        }
    }
    {
...
void create_screen_sound() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_sound_obj73, LV_EVENT_ALL, flowState);
            add_style_checkbox_default(obj);
        }
        {
            lv_obj_t *obj = lv_checkbox_create(parent_obj);
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_sound_obj74, LV_EVENT_ALL, flowState);
            add_style_checkbox_default(obj);
        }
        {
            lv_obj_t *obj = lv_checkbox_create(parent_obj);
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_sound_obj75, LV_EVENT_ALL, flowState);
            add_style_checkbox_default(obj);
        }
        {
            lv_obj_t *obj = lv_btn_create(parent_obj);
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_sound_obj76, LV_EVENT_ALL, flowState);
            add_style_selectbutton(obj);
            {
                lv_obj_t *parent_obj = obj;
                {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_sound_obj77, LV_EVENT_ALL, flowState);
            add_style_checkbox_default(obj);
        }
    }
}
...
static const char *object_names[] = { "startup", "main", "capacity", "settings", "events", "ranges", "nplc", "protections", "calibration", "fan", "display", "info", "sound", "obj0", "obj0__kbtext2", "obj0__obj0", "obj0__max_button", "obj0__min_button", "obj0__obj1", "obj0__obj2", "obj1", "obj1__kbtext2", "obj1__obj0", "obj1__max_button", "obj1__min_button", "obj1__obj1", "obj1__obj2", "obj2", "obj2__sure_but_yes", "obj2__sure_but_no", "obj2__sure_label_yes", "obj2__sure_label_no", "obj2__obj0", "obj2__obj1", "obj3", "obj3__sure_but_yes", "obj3__sure_but_no", "obj3__sure_label_yes", "obj3__sure_label_no", "obj3__obj0", "obj3__obj1", "obj4", "obj4__kbtext2", "obj4__obj0", "obj4__max_button", "obj4__min_button", "obj4__obj1", "obj4__obj2", "obj5", "obj5__kbtext2", "obj5__obj0", "obj5__max_button", "obj5__min_button", "obj5__obj1", "obj5__obj2", "obj6", "obj6__sure_but_yes", "obj6__sure_but_no", "obj6__sure_label_yes", "obj6__sure_label_no", "obj6__obj0", "obj6__obj1", "obj7", "obj7__sure_but_yes", "obj7__sure_but_no", "obj7__sure_label_yes", "obj7__sure_label_no", "obj7__obj0", "obj7__obj1", "obj8", "obj8__sure_but_yes", "obj8__sure_but_no", "obj8__sure_label_yes", "obj8__sure_label_no", "obj8__obj0", "obj8__obj1", "myspinbox", "mode_selector", "on_off_button", "range_current", "obj9", "obj10", "range_volt", "obj11", "obj12", "obj13", "obj14", "wh", "obj15", "obj16", "obj17", "obj18", "obj19", "obj20", "obj21", "range_volt_1", "obj22", "obj23", "obj24", "obj25", "obj26", "obj27", "on_off_button_1", "obj28", "obj29", "obj30", "obj31", "obj32", "obj33", "obj34", "obj35", "obj36", "obj37", "obj38", "obj39", "obj40", "obj41", "obj42", "obj43", "obj44", "obj45", "current_range", "volt_range", "sense", "nlpc_back", "nlpc_ok", "nlpc_cancel", "nplc_nplc", "pl_freq", "nlpc_home", "nlpc_home_cancel", "nlpc_home_cancel_1", "obj46", "obj47", "obj48", "obj49", "obj50", "obj51", "obj52", "obj53", "obj54", "obj55", "obj56", "obj57", "obj58", "obj59", "obj60", "obj61", "obj62", "obj63", "obj64", "obj65", "obj66", "obj67", "obj68", "nlpc_home_1", "nlpc_home_cancel_2", "nlpc_home_cancel_3", "nlpc_home_2", "nlpc_home_cancel_4", "nlpc_home_cancel_5", "obj69", "obj70", "obj71", "display_off", "nlpc_home_4", "nplc_nplc_1", "nlpc_home_3", "nlpc_home_cancel_6", "nlpc_home_cancel_7", "obj72", "obj73", "obj74", "obj75", "obj76", "obj77", "obj78", "main_measure", "sense_indicator", "obj79", "flex_panel", "capacity_panel", "ah", "montime", "stats_panel", "stat_min", "montime_3", "ah_10", "stat_avg", "stat_max", "montime_4", "main_lower_panel", "set_value", "isetlabel_1", "von_panel", "vonlabel", "protection_and_temp", "wheel", "main_dvm", "obj80", "obj81", "obj82", "obj83", "obj84", "obj85", "obj86", "obj87", "obj88", "obj89", "obj90", "obj91", "obj92", "obj93", "obj94", "obj95", "obj96", "ah_2", "ah_3", "ah_4", "ah_5", "ah_6", "ah_7", "obj97", "obj98", "obj99", "obj100", "obj101", "obj102", "obj103", "obj104", "obj105", "obj106", "obj107", "obj108", "obj109", "obj110", "obj111", "obj112", "obj113", "obj114", "obj115", "obj116", "obj117", "obj118", "obj119", "obj120", "obj121", "obj122", "obj123", "obj124", "obj125", "obj126", "obj127", "obj128", "obj129", "obj130", "obj131", "obj132", "obj133", "obj134", "obj135", "obj136", "obj137", "obj138", "obj139", "obj140", "obj141", "obj142", "obj143", "obj144", "obj145", "obj146", "obj147", "obj148", "obj149", "obj150", "obj151", "obj152", "obj153", "obj154", "obj155", "obj156", "obj157", "obj158", "obj159", "obj160", "obj161", "obj162", "obj163", "obj164", "obj165", "obj166", "obj167", "obj168", "obj169", "obj170", "obj171", "obj172", "obj173", "obj174", "obj175", "obj176", "obj177", "obj178", "obj179" };
