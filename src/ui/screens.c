...
static void event_handler_cb_fan_fan(lv_event_t *e) {
    ...
    if (event == LV_EVENT_SCREEN_LOAD_START) {
        ...
        lv_group_add_obj(groups.encoder_group, objects.obj72);
...
static void event_handler_cb_fan_obj72(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
void tick_screen_events() {
    ...
    }
    {
        ...
        const char *cur_val = lv_textarea_get_text(objects.obj49);
        if (strcmp(new_val, cur_val) != 0) {
            tick_value_change_obj = objects.obj49;
            lv_textarea_set_text(objects.obj49, new_val);
            tick_value_change_obj = NULL;
        }
    }
}
...
void tick_screen_calibration() {
    ...
    tick_user_widget_keyboard(getFlowState(flowState, 53), 51);
    {
        ...
        static struct {
            ...
            int32_t obj_obj69_rotate_init_value;
        } anim_state = { -1 };
        
        if (anim_state.last_timeline_position == -1) {
            anim_state.last_timeline_position = 0;
            anim_state.obj_obj69_rotate_init_value = lv_obj_get_style_prop(objects.obj69, LV_PART_MAIN, LV_STYLE_TRANSFORM_ROTATION).num;
        }
        ...
        if (timeline_position != anim_state.last_timeline_position) {
            ...
            
            {
                ...
                float rotate_value = anim_state.obj_obj69_rotate_init_value;
...
void create_screen_fan() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_fan_obj72, LV_EVENT_ALL, flowState);
            add_style_selector_small(obj);
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
...
void tick_screen_fan() {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_flag(objects.obj168, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj168;
            if (new_val) lv_obj_add_flag(objects.obj168, LV_OBJ_FLAG_HIDDEN);
            else lv_obj_clear_flag(objects.obj168, LV_OBJ_FLAG_HIDDEN);
            tick_value_change_obj = NULL;
        }
    }
    {
...
void tick_screen_display() {
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 30, 3, "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.obj170, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj170;
            if (new_val) lv_obj_add_flag(objects.obj170, LV_OBJ_FLAG_HIDDEN);
            else lv_obj_clear_flag(objects.obj170, LV_OBJ_FLAG_HIDDEN);
            tick_value_change_obj = NULL;
        }
    }
    {
...
void create_screen_stats() {
    ...
    add_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_stats_table(obj, getFlowState(flowState, 11), 79);
        }
        {
            lv_obj_t *obj = lv_obj_create(parent_obj);
            objects.obj10 = obj;
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_stats_table(obj, getFlowState(flowState, 12), 89);
        }
        {
            lv_obj_t *obj = lv_obj_create(parent_obj);
            objects.obj11 = obj;
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_stats_table(obj, getFlowState(flowState, 13), 99);
        }
    }
}
...
void tick_screen_stats() {
    ...
    tick_user_widget_stats_table(getFlowState(flowState, 11), 79);
    tick_user_widget_stats_table(getFlowState(flowState, 12), 89);
    tick_user_widget_stats_table(getFlowState(flowState, 13), 99);
}
