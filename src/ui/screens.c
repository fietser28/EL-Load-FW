...
static void event_handler_cb_main_on_off_button(lv_event_t *e) {
    ...
    if (event == LV_EVENT_VALUE_CHANGED) {
        ...
        if (tick_value_change_obj != ta) {
            ...
            assignBooleanProperty(flowState, 50, 3, value, "Failed to assign Checked state");
        }
    }
}
...
static void event_handler_cb_ranges_obj73(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_VALUE_CHANGED) {
        flowPropagateValue(flowState, 19, 0);
...
static void event_handler_cb_ranges_obj74(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_VALUE_CHANGED) {
        flowPropagateValue(flowState, 20, 0);
...
static void event_handler_cb_ranges_obj75(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_VALUE_CHANGED) {
        flowPropagateValue(flowState, 22, 0);
...
static void event_handler_cb_nplc_obj85(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_VALUE_CHANGED) {
        flowPropagateValue(flowState, 25, 0);
...
static void event_handler_cb_nplc_obj86(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_VALUE_CHANGED) {
...
static void event_handler_cb_protections_obj90(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
        flowPropagateValue(flowState, 22, 0);
...
static void event_handler_cb_protections_obj92(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
...
static void event_handler_cb_calibration_obj111(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
...
static void event_handler_cb_calibration_obj112(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
        flowPropagateValue(flowState, 34, 0);
...
static void event_handler_cb_calibration_obj119(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
...
static void event_handler_cb_fan_obj134(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_VALUE_CHANGED) {
        flowPropagateValue(flowState, 25, 0);
...
static void event_handler_cb_fan_obj136(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_VALUE_CHANGED) {
        flowPropagateValue(flowState, 29, 0);
...
static void event_handler_cb_display_obj142(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_VALUE_CHANGED) {
...
static void event_handler_cb_display_obj144(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_VALUE_CHANGED) {
        flowPropagateValue(flowState, 29, 0);
...
static void event_handler_cb_question_yn_obj77(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = e->user_data;
    if (event == LV_EVENT_PRESSED) {
...
void create_screen_main() {
    ...
    apply_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            create_user_widget_keyboard(obj, getFlowState(flowState, 90), 118);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
        }
    }
}
...
void tick_screen_main() {
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 50, 3, "Failed to evaluate Checked state");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 50, 4, "Failed to evaluate Disabled state");
    ...
    tick_user_widget_keyboard(getFlowState(flowState, 90), 118);
}
...
void create_screen_capacity() {
    ...
    apply_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_local_style_prop(obj, LV_STYLE_BG_OPA, value, LV_PART_MAIN);
            lv_obj_set_local_style_prop(obj, LV_STYLE_BORDER_WIDTH, value, LV_PART_MAIN);
            create_user_widget_keyboard(obj, getFlowState(flowState, 46), 146);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
        }
        {
            lv_obj_t *obj = lv_obj_create(parent_obj);
...
void tick_screen_capacity() {
    ...
    tick_user_widget_keyboard(getFlowState(flowState, 46), 146);
}
...
void create_screen_ranges() {
    ...
    apply_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_ranges_obj73, LV_EVENT_ALL, flowState);
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_ranges_obj74, LV_EVENT_ALL, flowState);
            apply_style_selector_small(obj);
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_ranges_obj75, LV_EVENT_ALL, flowState);
        }
        {
            lv_obj_t *obj = lv_obj_create(parent_obj);
            objects.obj76 = obj;
            ...
            lv_obj_set_local_style_prop(obj, LV_STYLE_BG_OPA, value, LV_PART_MAIN);
            lv_obj_set_local_style_prop(obj, LV_STYLE_BORDER_WIDTH, value, LV_PART_MAIN);
            create_user_widget_question_yn(obj, getFlowState(flowState, 23), 184);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
        }
    }
}
...
void tick_screen_ranges() {
    ...
    }
    {
        ...
        int32_t cur_val = lv_dropdown_get_selected(objects.obj73);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj73;
            lv_dropdown_set_selected(objects.obj73, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    tick_user_widget_question_yn(getFlowState(flowState, 23), 184);
}
...
void create_screen_nplc() {
    ...
    apply_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_nplc_obj85, LV_EVENT_ALL, flowState);
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_nplc_obj86, LV_EVENT_ALL, flowState);
            apply_style_selector_small(obj);
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
        ...
        }
        {
            ...
            lv_obj_set_local_style_prop(obj, LV_STYLE_BG_OPA, value, LV_PART_MAIN);
            lv_obj_set_local_style_prop(obj, LV_STYLE_BORDER_WIDTH, value, LV_PART_MAIN);
            create_user_widget_question_yn(obj, getFlowState(flowState, 31), 197);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
        }
    }
}
...
void tick_screen_nplc() {
    ...
    }
    {
        ...
        int32_t cur_val = lv_slider_get_value(objects.obj85);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj85;
            lv_slider_set_value(objects.obj85, new_val, LV_ANIM_OFF);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    tick_user_widget_question_yn(getFlowState(flowState, 31), 197);
}
...
void create_screen_protections() {
    ...
    apply_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_protections_obj90, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            apply_style_selectbutton(obj);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_protections_obj92, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            apply_style_select_button_red_green(obj);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_obj_set_local_style_prop(obj, LV_STYLE_BG_OPA, value, LV_PART_MAIN);
            lv_obj_set_local_style_prop(obj, LV_STYLE_BORDER_WIDTH, value, LV_PART_MAIN);
            create_user_widget_keyboard(obj, getFlowState(flowState, 46), 50);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
        }
    }
}
...
void tick_screen_protections() {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_state(objects.obj92, LV_STATE_CHECKED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj92;
            if (new_val) lv_obj_add_state(objects.obj92, LV_STATE_CHECKED);
            else lv_obj_clear_state(objects.obj92, LV_STATE_CHECKED);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_state(objects.obj94, LV_STATE_CHECKED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj94;
            if (new_val) lv_obj_add_state(objects.obj94, LV_STATE_CHECKED);
            else lv_obj_clear_state(objects.obj94, LV_STATE_CHECKED);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    tick_user_widget_keyboard(getFlowState(flowState, 46), 50);
}
...
void create_screen_calibration() {
    ...
    apply_style_screen_background(obj);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_calibration_obj111, LV_EVENT_ALL, flowState);
            apply_style_selector_small(obj);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
        }
        {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_calibration_obj112, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            apply_style_selectbutton(obj);
            lv_obj_set_style_align(obj, LV_ALIGN_DEFAULT, LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 45, 32);
            lv_obj_add_event_cb(obj, event_handler_cb_calibration_obj119, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            apply_style_selectbutton(obj);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_obj_set_local_style_prop(obj, LV_STYLE_BG_OPA, value, LV_PART_MAIN);
            lv_obj_set_local_style_prop(obj, LV_STYLE_BORDER_WIDTH, value, LV_PART_MAIN);
            create_user_widget_keyboard(obj, getFlowState(flowState, 53), 76);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
        }
    }
}
...
void tick_screen_calibration() {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_state(objects.obj118, LV_STATE_DISABLED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj118;
            if (new_val) lv_obj_add_state(objects.obj118, LV_STATE_DISABLED);
            else lv_obj_clear_state(objects.obj118, LV_STATE_DISABLED);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    }
    {
        ...
        bool cur_val = lv_obj_has_state(objects.obj119, LV_STATE_DISABLED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj119;
            if (new_val) lv_obj_add_state(objects.obj119, LV_STATE_DISABLED);
            else lv_obj_clear_state(objects.obj119, LV_STATE_DISABLED);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    tick_user_widget_keyboard(getFlowState(flowState, 53), 76);
    {
        float timeline_position = getTimelinePosition(flowState);
        
        static struct {
            float last_timeline_position;
            int32_t obj_obj126_rotate_init_value;
        } anim_state = { -1 };
        
        if (anim_state.last_timeline_position == -1) {
            anim_state.last_timeline_position = 0;
            anim_state.obj_obj126_rotate_init_value = lv_obj_get_style_prop(objects.obj126, LV_PART_MAIN, LV_STYLE_TRANSFORM_ANGLE).num;
        }
        ...
        if (timeline_position != anim_state.last_timeline_position) {
            ...
            {
                lv_obj_t *obj = objects.obj126;
                
                float rotate_value = anim_state.obj_obj126_rotate_init_value;
    ...
    void create_screen_fan() {
        ...
        apply_style_screen_background(obj);
        {
            ...
            }
            {
                ...
                lv_obj_add_event_cb(obj, event_handler_cb_fan_obj134, LV_EVENT_ALL, flowState);
                apply_style_slider(obj);
            }
            {
                lv_obj_t *obj = lv_label_create(parent_obj);
            ...
            }
            {
                ...
                lv_obj_add_event_cb(obj, event_handler_cb_fan_obj136, LV_EVENT_ALL, flowState);
                apply_style_selector_small(obj);
            }
            {
                lv_obj_t *obj = lv_label_create(parent_obj);
            ...
            }
            {
                ...
                lv_obj_set_local_style_prop(obj, LV_STYLE_BG_OPA, value, LV_PART_MAIN);
                lv_obj_set_local_style_prop(obj, LV_STYLE_BORDER_WIDTH, value, LV_PART_MAIN);
                create_user_widget_question_yn(obj, getFlowState(flowState, 31), 92);
                lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            }
        }
    }
    ...
    void tick_screen_fan() {
        ...
        }
        {
            ...
            int32_t cur_val = lv_slider_get_value(objects.obj134);
            if (new_val != cur_val) {
                tick_value_change_obj = objects.obj134;
                lv_slider_set_value(objects.obj134, new_val, LV_ANIM_OFF);
                tick_value_change_obj = NULL;
            }
        }
        {
        ...
        {
            int32_t new_val = evalIntegerProperty(flowState, 29, 3, "Failed to evaluate Selected in Dropdown widget");
            int32_t cur_val = lv_dropdown_get_selected(objects.obj136);
            if (new_val != cur_val) {
                tick_value_change_obj = objects.obj136;
                lv_dropdown_set_selected(objects.obj136, new_val);
                tick_value_change_obj = NULL;
            }
        }
        {
        ...
        tick_user_widget_question_yn(getFlowState(flowState, 31), 92);
    }
    ...
    void create_screen_display() {
        ...
        apply_style_screen_background(obj);
        {
            ...
            }
            {
                ...
                lv_obj_set_size(obj, 180, 10);
                lv_obj_add_event_cb(obj, event_handler_cb_display_obj142, LV_EVENT_ALL, flowState);
                apply_style_slider(obj);
            }
            {
                lv_obj_t *obj = lv_label_create(parent_obj);
            ...
            }
            {
                ...
                lv_obj_set_size(obj, 102, 36);
                lv_dropdown_set_options(obj, "Auto\nManual");
                lv_obj_add_event_cb(obj, event_handler_cb_display_obj144, LV_EVENT_ALL, flowState);
                apply_style_selector_small(obj);
            }
            {
                lv_obj_t *obj = lv_label_create(parent_obj);
            ...
            }
            {
                ...
                lv_obj_set_local_style_prop(obj, LV_STYLE_BG_OPA, value, LV_PART_MAIN);
                lv_obj_set_local_style_prop(obj, LV_STYLE_BORDER_WIDTH, value, LV_PART_MAIN);
                create_user_widget_question_yn(obj, getFlowState(flowState, 33), 105);
                lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            }
            {
                // display OFF
    ...
    void tick_screen_display() {
        ...
        }
        {
            ...
            int32_t cur_val = lv_slider_get_value(objects.obj142);
            if (new_val != cur_val) {
                tick_value_change_obj = objects.obj142;
                lv_slider_set_value(objects.obj142, new_val, LV_ANIM_OFF);
                tick_value_change_obj = NULL;
            }
        }
        {
        ...
        {
            int32_t new_val = evalIntegerProperty(flowState, 29, 3, "Failed to evaluate Selected in Dropdown widget");
            int32_t cur_val = lv_dropdown_get_selected(objects.obj144);
            if (new_val != cur_val) {
                tick_value_change_obj = objects.obj144;
                lv_dropdown_set_selected(objects.obj144, new_val);
                tick_value_change_obj = NULL;
            }
        }
        {
            bool new_val = evalBooleanProperty(flowState, 30, 3, "Failed to evaluate Hidden flag");
            bool cur_val = lv_obj_has_flag(objects.obj145, LV_OBJ_FLAG_HIDDEN);
            if (new_val != cur_val) {
                tick_value_change_obj = objects.obj145;
                if (new_val) lv_obj_add_flag(objects.obj145, LV_OBJ_FLAG_HIDDEN);
                else lv_obj_clear_flag(objects.obj145, LV_OBJ_FLAG_HIDDEN);
                tick_value_change_obj = NULL;
            }
        }
        {
        ...
        tick_user_widget_question_yn(getFlowState(flowState, 33), 105);
        {
            ...
            }
            {
                ...
                apply_style_warning(obj);
                {
                    lv_obj_t *parent_obj = obj;
                    {
                        ...
                        lv_obj_add_event_cb(obj, event_handler_cb_question_yn_obj77, LV_EVENT_ALL, flowState);
                        lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
                        lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
                        apply_style_button(obj);
                        {
