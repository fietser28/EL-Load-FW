...
extern float get_var_imon();
extern void set_var_imon(float value);
extern float get_var_umon();
extern void set_var_umon(float value);
extern float get_var_pmon();
extern void set_var_pmon(float value);
extern float get_var_rmon();
extern void set_var_rmon(float value);
...
extern int32_t get_var_imon_nplc();
extern void set_var_imon_nplc(int32_t value);
extern int32_t get_var_umon_nplc();
extern void set_var_umon_nplc(int32_t value);
